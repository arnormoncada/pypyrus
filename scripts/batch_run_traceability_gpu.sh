...
#BSUB -W 04:00
#BSUB -o logs/pypyrus_traceability_%J.out
#BSUB -e logs/pypyrus_traceability_%J.err
#BSUB -B
#BSUB -N
...
OUTPUT_ROOT="${OUTPUT_ROOT:-experiments/results/traceability_support}"
...
PLANT_EPOCHS="${PLANT_EPOCHS:-1}"
COVTYPE_EPOCHS="${COVTYPE_EPOCHS:-1}"
